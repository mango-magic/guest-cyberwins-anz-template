        ...
        <div className="mx-auto max-w-4xl space-y-12">
          ...
          <div className="space-y-8 text-center">
            <p className="font-sans text-lg leading-relaxed text-white/80 md:text-xl font-light">
              Enterprise security leaders are under constant pressure - from boards, regulators, customers, and attackers. When things go wrong, expectations are higher, tolerance is lower, and scrutiny is immediate.
            </p>
