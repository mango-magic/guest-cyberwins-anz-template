        ...
        <div className="mx-auto max-w-5xl space-y-16">
          ...
          <div className="text-center space-y-6 animate-fade-in">
            ...
            <p className="font-sans text-lg text-white/70 md:text-xl font-light max-w-3xl mx-auto leading-relaxed">
              CyberWins is a podcast featuring CISOs and senior cybersecurity leaders unpacking one real cyber win at a time.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <a
              href="https://open.spotify.com/show/3LLH2tfpsiHa0Db6mIqoqQ?si=gxffXfxWRhS4ige-MLTFtg"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-[#1DB954] hover:bg-[#1ed760] text-white font-semibold text-base transition-all duration-300 hover:scale-105 shadow-[0_0_25px_rgba(29,185,84,0.3)]"
            >
            ...
            <a
              href="https://www.youtube.com/@CyberWinsPodcastUSA"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-[#FF0000] hover:bg-[#cc0000] text-white font-semibold text-base transition-all duration-300 hover:scale-105 shadow-[0_0_25px_rgba(255,0,0,0.3)]"
            >
